...
Features:
- Acts as a proxy, receiving API calls from clients and routing them to the appropriate backend.
- Implements caching and retry mechanisms; masks backend network errors by retrying from an in-memory queue that can spool to file when full.
